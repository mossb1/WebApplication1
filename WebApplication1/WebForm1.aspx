        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    ...
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="margin-left: 22px" Text="Search" Width="90px" />
                </td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" 
                        emptydatatext="No data available." allowpaging="True" PageSize="20" AutoGenerateColumns="true" GridLinesBoth="true">
